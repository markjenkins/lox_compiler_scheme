...
test4.lox.output.txt: bytecode_interpreter test4.lox test4.output.txt test4.lox.expected.txt
	...
	bytecode_interpreter/exprprint.gcc < test4.output.txt > test4.lox.output.gcc.txt
	cmp test4.lox.expected.txt test4.lox.output.gcc.txt

test5.lox.output.txt: bytecode_interpreter test5.lox test5.output.txt test5.lox.expected.txt
	./exprprint.bash test5.output.txt > test5.lox.output.txt
	cmp test5.lox.expected.txt test5.lox.output.txt
	bytecode_interpreter/exprprint.gcc < test5.output.txt > test5.lox.output.gcc.txt
	cmp test5.lox.expected.txt test5.lox.output.gcc.txt

test6.lox.output.txt: bytecode_interpreter test6.lox test6.output.txt test6.lox.expected.txt
	./exprprint.bash test6.output.txt > test6.lox.output.txt
	cmp test6.lox.expected.txt test6.lox.output.txt
	bytecode_interpreter/exprprint.gcc < test6.output.txt > test6.lox.output.gcc.txt
	cmp test6.lox.expected.txt test6.lox.output.gcc.txt

test7.lox.output.txt: bytecode_interpreter test7.lox test7.output.txt test7.lox.expected.txt
	./exprprint.bash test7.output.txt > test7.lox.output.txt
	cmp test7.lox.expected.txt test7.lox.output.txt
	bytecode_interpreter/exprprint.gcc < test7.output.txt > test7.lox.output.gcc.txt
	cmp test7.lox.expected.txt test7.lox.output.gcc.txt

test8.lox.output.txt: bytecode_interpreter test8.lox test8.output.txt test8.lox.expected.txt
	./exprprint.bash test8.output.txt > test8.lox.output.txt
	cmp test8.lox.expected.txt test8.lox.output.txt
	bytecode_interpreter/exprprint.gcc < test8.output.txt > test8.lox.output.gcc.txt
	cmp test8.lox.expected.txt test8.lox.output.gcc.txt

test9.lox.output.txt: bytecode_interpreter test9.lox test9.output.txt test9.lox.expected.txt
	./exprprint.bash test9.output.txt > test9.lox.output.txt
	cmp test9.lox.expected.txt test9.lox.output.txt
	bytecode_interpreter/exprprint.gcc < test9.output.txt > test9.lox.output.gcc.txt
	cmp test9.lox.expected.txt test9.lox.output.gcc.txt

test10.lox.output.txt: bytecode_interpreter test10.lox test10.output.txt test10.lox.expected.txt
	./exprprint.bash test10.output.txt > test10.lox.output.txt
	cmp test10.lox.expected.txt test10.lox.output.txt
	bytecode_interpreter/exprprint.gcc < test10.output.txt > test10.lox.output.gcc.txt
	cmp test10.lox.expected.txt test10.lox.output.gcc.txt

test11.lox.output.txt: bytecode_interpreter test11.lox test11.output.txt test11.lox.expected.txt
	./exprprint.bash test11.output.txt > test11.lox.output.txt
	cmp test11.lox.expected.txt test11.lox.output.txt
	bytecode_interpreter/exprprint.gcc < test11.output.txt > test11.lox.output.gcc.txt
	cmp test11.lox.expected.txt test11.lox.output.gcc.txt
...
test12.lox.output.txt: bytecode_interpreter test12.lox test12.output.txt test12.lox.expected.txt
	...
	bytecode_interpreter/exprprint.gcc < test12.output.txt > test12.lox.output.gcc.txt
	cmp test12.lox.expected.txt test12.lox.output.gcc.txt
...
test13.lox.output.txt: bytecode_interpreter test13.lox test13.output.txt test13.lox.expected.txt
	...
	bytecode_interpreter/exprprint.gcc < test13.output.txt > test13.lox.output.gcc.txt
	cmp test13.lox.expected.txt test13.lox.output.gcc.txt
